...
class johnsons_algorithm:
 ...
 def is_self_loop(G:Automata_t,vertex:tuple) -> bool:
    """
    Given an automata and vertex tuple, returns True if the vertex contains
    ...
    try:
        ...
        return False
    if vertex == vertices[vertex["out"][0][0]]:
        return True
    return False